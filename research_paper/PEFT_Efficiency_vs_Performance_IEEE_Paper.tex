...
Table~\ref{tab:hyperparams} lists all hyperparameters. Critically, a \textbf{uniform learning rate of $2{\times}10^{-5}$} was applied to \emph{all} methods including all PEFT configurations---both PEFT and Full FT use the same learning rate. Experiments ran on Google Colab (NVIDIA T4 GPU) using HuggingFace PEFT v0.10.0.
